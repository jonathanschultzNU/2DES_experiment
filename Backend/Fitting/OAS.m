function [ExponentialFits,OscFits,LowOscFits] = OAS(datain)
...
criterion = 6; %-1; %-2; %Information criterion for itcmp, -1 uses AIC, -2 MDL 
...
[ExponentialFits,OscFits,LowOscFits] = OscillationAssociatedSpectrum(data, ...
